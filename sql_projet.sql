...
INSERT INTO Client (Nom, Prenom, AdresseMail, Telephone, IdRang) VALUES
...
SELECT Client.Nom AS NomClient, Client.Prenom AS PrenomClient, Rang.LibelleRang AS Rang, TypeVetement.LibelleTypeVetement AS TypeVetement, SUM(Depose.Quantite_Deposee) AS TotalDeposee
...
GROUP BY Client.Nom, Client.Prenom, TypeVetement.LibelleTypeVetement, Rang.LibelleRang
ORDER BY NomClient, PrenomClient, TypeVetement;

SELECT Benne.Adresse AS AdresseBenne, TypeVetement.LibelleTypeVetement AS TypeVetement, SUM(Collecte.Quantite_Collectee) AS TotalCollectee
...
SELECT Client.Nom AS NomClient, Client.Prenom AS PrenomClient, Rang.LibelleRang AS Rang, SUM(Achete.Quantite_Achetee) AS TotalAchetee
